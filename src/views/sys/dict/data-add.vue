      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="字典标签" prop="dictLabel">
            <el-input v-model="dict.dictLabel" placeholder="请输入字典标签" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="字典键值" prop="dictValue">
            <el-input v-model="dict.dictValue" placeholder="请输入字典键值" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="字典排序">
            <el-input-number v-model="dict.dictSort" :min="1" :max="99" placeholder="字典排序" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
...
export default {
  ...
  created() {
    this.dict.dictType = this.type
  },
  methods: {
    onSubmit() {
      dictDataApi.save(this.dict).then(res => {
